...
namespace SM.DAL.Migrations
{
    ...
    [Migration("20260520205352_ChangeBirthdateToDateOnly")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SM.DAL.DataModel.ChurchMember", b =>
                {
                    b.Property<int>("ChurchID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SM.DAL.DataModel.Class", b =>
                {
                    ...
                    b.Property<DateOnly?>("AgeEndDate")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("AgeStartDate")
                        .HasColumnType("date");
                    ...
                    b.Property<string>("ClassFrequency")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("varchar(10)");
            ...
            modelBuilder.Entity("SM.DAL.DataModel.MedicalAppointment", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("MedicalAppointmentID"));
            ...
            modelBuilder.Entity("SM.DAL.DataModel.Member", b =>
                {
                    ...
                    b.Property<DateTime?>("LastVisitationDate")
                        .HasColumnType("datetime(6)");

                    b.Property<string>("LastVisitationType")
                        .HasMaxLength(20)
                        .HasColumnType("varchar(20)");
            ...
            modelBuilder.Entity("SM.DAL.DataModel.Permission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SM.DAL.DataModel.RolePermission", b =>
                {
                    b.Property<string>("RoleId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("SM.DAL.DataModel.MedicalAppointment", b =>
                {
                    ...
                    b.HasOne("SM.DAL.DataModel.Servant", "Pharmacist")
                        .WithMany()
            ...
            modelBuilder.Entity("SM.DAL.DataModel.RolePermission", b =>
                {
                    b.HasOne("SM.DAL.DataModel.Permission", "Permission")
