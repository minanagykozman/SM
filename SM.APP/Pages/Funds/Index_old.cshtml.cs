...
{
    [Authorize]
    public class Index_oldModel : PageModelBase
    {
        ...
        public Index_oldModel(UserManager<IdentityUser> userManager, ILogger<IndexModel> logger, IConfiguration configuration) : base(userManager, logger)
        {
